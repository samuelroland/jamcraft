-- Note: these are a few data to make the development easier, audio files must be present in audio/x.mp3 at repository root
-- They are disabled by default, so we can test the "empty" interface and uploading the first sample and creating the first sample
--
